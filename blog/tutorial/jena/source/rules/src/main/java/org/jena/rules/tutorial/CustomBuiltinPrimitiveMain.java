...
public class CustomBuiltinPrimitiveMain {
  private static Logger logger = LoggerFactory.getLogger(CustomBuiltinPrimitiveMain.class);
  ...
  public static void main(String[] args) {
    try {
      ...
      // Load RDF data
      String data = path.toFile().getAbsolutePath() + "/src/main/resources/data2.ttl";
      ...
      // Load rules
      String rules = path.toFile().getAbsolutePath() + "/src/main/resources/student2.rules";
